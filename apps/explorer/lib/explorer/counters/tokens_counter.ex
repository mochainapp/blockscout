defmodule Explorer.Counters.TokensCounter do
  @moduledoc """
  Caches the number of all token.
  ...
  # the test env.
  config = Application.get_env(:explorer, Explorer.Counters.TokensCounter)
  ...
  `config :explorer, Explorer.Counters.TokensCounter, enable_consolidation: true`

  to:

  `config :explorer, Explorer.Counters.TokensCounter, enable_consolidation: false`
  """
